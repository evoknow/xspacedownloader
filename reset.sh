...
# Tables to truncate
TABLES=("space_clips" "space_cost" "space_download_history" "space_download_scheduler" "space_favs" "space_metadata" "space_notes" "space_play_history" "space_reviews" "space_tags" "space_transcripts" "spaces" "computes")
